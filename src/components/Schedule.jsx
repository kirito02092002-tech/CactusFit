...
import { PLANNING_POSTERS, SCHEDULE, SCHEDULE_KEYS } from '../data/content';
  ...
  return (
    <section id="planning" className="schedule" data-section-glow>
      ...
      <div className="container">
        ...
        <div className="schedule__poster-wrap" data-liquid="scale">
          <img
            src={PLANNING_POSTERS[activeDay]}
            alt={`${t.schedule.label} — ${t.schedule.days[activeDay]}`}
            className="schedule__poster"
          />
        </div>
